...
function __init__()
    ...
    external_url = "https://unpkg.com/feffery_markdown_components@0.3.0-rc1/feffery_markdown_components/feffery_markdown_components.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_markdown_components@0.3.0-rc1/feffery_markdown_components/feffery_markdown_components.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
