...
function __init__()
    ...
    external_url = "https://unpkg.com/feffery_markdown_components@0.4.0-rc2/feffery_markdown_components/feffery_markdown_components.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_markdown_components@0.4.0-rc2/feffery_markdown_components/feffery_markdown_components.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
